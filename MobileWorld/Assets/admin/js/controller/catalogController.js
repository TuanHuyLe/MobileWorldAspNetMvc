        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    if (model.id == 0) {
                        bootbox.alert("Thêm thất bại! Sản phẩm này đã tồn tại");
                        window.setTimeout(function () {
                            bootbox.hideAll();
                        }, 2000);
                    } else {
